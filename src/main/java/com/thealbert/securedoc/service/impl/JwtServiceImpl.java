...
import com.thealbert.securedoc.domain.Token;
import com.thealbert.securedoc.domain.TokenData;
import com.thealbert.securedoc.dto.User;
import com.thealbert.securedoc.enumeration.TokenType;
import com.thealbert.securedoc.function.TriConsumer;
import com.thealbert.securedoc.security.JwtConfiguration;
...
import static com.thealbert.securedoc.constant.Constants.*;
...
public class JwtServiceImpl extends JwtConfiguration implements JwtService {
    ...
    private <T> T getClaimsValue(String token, Function<Claims, T> claim) {
        return claimsFunction.andThen(claim).apply(token);
    }
